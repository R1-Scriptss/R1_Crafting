...
RegisterNetEvent('r1_crafting:setup')
AddEventHandler('r1_crafting:setup', function()
                        ...
                        options = {
                            {
                                ...
                                event = 'r1_crafting:menu',
                                onSelect = function()
                                    TriggerEvent("r1_crafting:menu", name)
                                end,
                                distance = 1,
                            }
                        }
...
RegisterNetEvent('r1_crafting:menu')
AddEventHandler('r1_crafting:menu', function(craftingType)
    ...
    for _, craftingOption in ipairs(craftingData.items) do
        local option = {
            ...
            onSelect = function()
                TriggerServerEvent('r1_crafting:giveitems', craftingType, craftingOption)
            end,
        }
...
lib.callback.register('r1_crafting:serverprogress', function(src, text, time)
...
CreateThread(function()
    TriggerEvent('r1_crafting:setup')
end)
